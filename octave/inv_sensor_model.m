...
laserEndPnts = robotlaser_as_cartesian(scan, 30 , true);
...
for sc=1:columns(laserEndPntsMapFrame)
  ...
  [freeX, freeY] = bresenham([robPoseMapFrame(1),  robPoseMapFrame(2); laserEndPntsMapFrame(1,sc), laserEndPntsMapFrame(2,sc) ]);

  %TODO: add them to freeCells
  freeCells = [ freeX(2:end-1)' freeY(2:end-1)'; freeCells ];
